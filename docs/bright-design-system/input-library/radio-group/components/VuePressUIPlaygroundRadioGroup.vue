<template>
    <BrightGrid>
        <BrightRow gutters="none">
            <BrightColumn>
                <BrightCard>
                    <BrightRadioGroup v-model="vModelData" v-bind="inputBindings"/>
                </BrightCard>
            </BrightColumn>
        </BrightRow>
...
export default {
    name: "VuePressUIPlaygroundRadioGroup",
    components: {
        BrightRadioGroup,
        BrightIcon,
        BrightInputGroup,
    ...
    data() {
        return {
            label: 'Which pet would you like to adopt next?',
            subLabel: '',
            size: 'medium',
            variant: 'standard',
            disabled: false,
    ...
    computed: {
        inputBindings() {
            return {
                ...
                options: [
                    { id: 'radioInput1', label: 'Dog', value: 'radioInput1' },
                    { id: 'radioInput2', label: 'Cat', value: 'radioInput2' },
                    { id: 'radioInput3', label: 'None of the above', subLabel: "It's okay; they'll adopt you.", value: 'radioInput3' },
                ],
                size: this.size,
