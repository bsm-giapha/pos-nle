<template>
    <BrightGrid>
        <BrightRow gutters="none">
            <BrightColumn>
                <BrightCard>
                    <BrightInputTextarea v-model="vModelData" v-bind="inputBindings"/>
                </BrightCard>
            </BrightColumn>
        </BrightRow>
...
import BrightInputTextarea from "@/bright/components/input-library/textarea/BrightInputTextarea";
export default {
    name: "VuePressUIPlaygroundTextarea",
    components: {
        BrightIcon,
        BrightInputGroup,
        BrightDropdownSelect,
    ...
    data() {
        return {
            ...
            subLabel: 'Please provide your entire life story.',
            placeholder: '',
            size: 'medium',
            rounded: false,
            disabled: false,
