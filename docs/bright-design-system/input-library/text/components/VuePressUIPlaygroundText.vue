<template>
    <BrightGrid>
        <BrightRow gutters="none">
            <BrightColumn>
                <BrightCard>
                    <BrightInputText v-model="vModelData" v-bind="inputBindings"/>
                </BrightCard>
            </BrightColumn>
        </BrightRow>
                    ...
                    <BrightRow class="mt-24">
                        ...
                        <BrightColumn tablet="6">
                            ...
                            <BrightInputGroup label="Toggleable" class="mb-8">
                                ...
                                <BrightSwitch id="playgroundCapitalize" v-model="capitalize" label="Capitalize"/>
                            </BrightInputGroup>
                        </BrightColumn>
                    </BrightRow>
                </BrightCard>
...
export default {
    ...
    data() {
        return {
            label: 'Favorite Word',
            subLabel: "Words are pretty cool.",
            placeholder: '',
            size: 'medium',
            rounded: false,
            disabled: false,
