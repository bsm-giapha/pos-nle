<template>
    <BrightGrid>
        <BrightRow gutters="none">
            <BrightColumn>
                <BrightCard>
                    <BrightInputEmail v-model="vModelData" v-bind="inputBindings"/>
                </BrightCard>
            </BrightColumn>
        </BrightRow>
...
import BrightInputEmail from "@/bright/components/input-library/email/BrightInputEmail";
...
export default {
    name: "VuePressUIPlaygroundEmail",
    components: {
        BrightIcon,
        BrightInputGroup,
        BrightDropdownSelect,
    ...
    data() {
        return {
            label: 'Email Address',
            subLabel: 'Please provide your email address.',
