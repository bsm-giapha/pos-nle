    ...
    <div>
        <BrightCard :bordered="false" class="AppPagePadding" no-padding>
            <BrightTable
                ...
                :bordered="false"
                :columns="[
                    { name: 'Send Email', key: 'sendEmail', excludeFromSearch: true, sort: 'none', filterable: true, },
...
export default {
    ...
    computed: {
        resourceURL() {
            ...
            return `${lender.baseLenderURL}/internal-emails`;
        },
    },
    methods: {
