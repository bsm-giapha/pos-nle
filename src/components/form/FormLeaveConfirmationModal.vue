<template>
    <BrightModalPopup v-bind="modalBindings" @closed="handleCancel">
        <template v-slot:footer>
            <div class="block tablet:flex">
                <BrightButton
                    ...
                    use="primary"
                    @click="handleCancel"
                    @keydown.space.enter.prevent="handleCancel"
                >
                    Review Changes
                </BrightButton>
                ...
                <BrightButton
                    ...
                    use="secondary"
                    @click="handleConfirm"
                    @keydown.space.enter.prevent="handleConfirm"
                >
                    Leave Page
                </BrightButton>
            </div>
...
export default {
    name: "FormLeaveConfirmationModal",
    components: {
        BrightButton,
        BrightModalPopup,
    },
    ...
    computed: {
        modalBindings() {
            return {
                ...
                subLabel: 'Are you sure you want to leave? You\'ll lose your recent changes.',
                show: this.show,
            };
        },
    },
